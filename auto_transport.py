...
def optimize_auto_transport(params):
    n = len(params["items"])
...
if __name__=="__main__":
    items = [{{"name": "S1", "cost": 3.2, "capacity": 44000}},
             {{"name": "S2", "cost": 2.8, "capacity": 44000}},
             {{"name": "S3", "cost": 3.8, "capacity": 44000}}]
    print(optimize_auto_transport({{"items": items, "demand": 100000}}))
